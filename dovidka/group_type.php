...
<html>
<head>
<title>СФКНАУ - Довідка - Види груп</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li  class="active" class="dop-menu"><a href="group_type.php"><svg class="glyph stroked chevron right"><use xlink:href="#stroked-chevron-right"/></svg> Види груп</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Види навчальних груп</div>
					<div class="panel-body">
						<div>
							<p style="cursor: pointer;"><button id="popup" class="btn btn-default" style="margin-right: 5px;" >Додати запис</button><button id="del_group_type" class="btn btn-default" style="margin-right: 5px;">Видалити запис</button></p>
						...
						<div id="parent_popup">
							<form role="form" onSubmit="return false">
								<div id="input_data" class="form-group">
									...
									<input id="type_name" name="type_name" onfocus="this.value=''" class="form-control" placeholder="Введіть назву виду навчальної групи">	
								</div>
								<button id="add_group_type" type="submit" class="btn btn-primary">Додати</button>
							</form>
						</div>
						<div>
						    ...
						    <?php include '../incdb/inc_group_type.php' ?>
							</table>
						</div>
					</div>
				</div>
