...
<title>СФКНАУ - Довідка - Дисципліни</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="dop-menu, active"><a href="subjects.php"><svg class="glyph stroked chevron right"><use xlink:href="#stroked-chevron-right"/></svg> Дисципліни</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Перелік дисциплін </div>
					<div class="panel-body">
						<div>
							<p style="cursor: pointer;"><button id="popup" class="btn btn-default" style="margin-right: 5px;" >Додати запис</button><button id="del_subjects" class="btn btn-default" style="margin-right: 5px;">Видалити запис</button></p>							
						</div>
						...
						<div id="parent_popup">
							<form role="form" onSubmit="return false">
								<div id="input_data" class="form-group">
									...
									<input id="subject_name" onfocus="this.value=''" name="subject_name" class="form-control" placeholder="Введіть назву дисципліни">	
								</div>
								<button id="add_subjects" type="submit" class="btn btn-primary">Додати</button>
								<button id="add_subjects_add" type="submit" class="btn btn-primary">Додати кілька</button>
							</form>
						</div>
						<div>
						    ...
						    <thead>
						    	<tr>
						        	...
						        	<th data-sortable="true">Назва дісципліни</th>
						    	</tr>
						    </thead>
						    <?php include '../incdb/inc_subjects.php' ?>
							</table>
						</div>
