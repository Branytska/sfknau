...
<title>СФКНАУ - Довідка - Групи</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="dop-menu, active"><a href="study_groups.php"><svg class="glyph stroked chevron right"><use xlink:href="#stroked-chevron-right"/></svg> Групи</a></li>
			...
			<li class="dop-menu"><a href="teachers.php"><svg class="glyph stroked chevron right"><use xlink:href="#stroked-chevron-right"/></svg> Викладачі</a></li>
		</ul>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Перелік навчальних груп</div>
					<div class="panel-body">
						<div>
							<p style="cursor: pointer;"><button id="popup" class="btn btn-default" style="margin-right: 5px;" >Додати запис</button><button id="del_study_groups" class="btn btn-default" style="margin-right: 5px;">Видалити запис</button></p>
							<div id="result_add"></div>
						</div>
						<div id="parent_popup">
							<form role="form" name="add_study_groups" method="post" action="" onSubmit="return false">
								<div id="input_data" class="form-group">
									<div id="result_add"></div>
									<label>Вид групи</label>
									<select class="form-control" id="group_type">
										<?php include "../dovidka_db/group_type.php"?>
									</select>
									<label>Номер групи</label>
									<input id="group_name" name="group_name" onfocus="this.value=''" class="form-control" placeholder="Введіть номер групи">	
								</div>
								<button id="add_study_groups" type="submit" class="btn btn-primary">Додати</button>
							</form>
						</div>
						<table id="data_table" data-toggle="table"  data-show-columns="true" data-search="true" data-select-item-name="toolbar1" data-pagination="true" data-sort-name="name" data-sort-order="desc">
						    <thead>
						    	<tr>
						        	...
						        	<th data-sortable="true">Вид групи</th>
						        	<th data-sortable="true">Номер групи</th>
						    	</tr>
						    </thead>
						    <?php include '../incdb/inc_study_groups.php' ?>
						</table>
					</div>
				</div>
			</div>
