...
<html>
<head>
<title>СФКНАУ - Звіт - Викладач</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="dop-menu, active"><a href="teacher.php"><svg class="glyph stroked chevron right"><use xlink:href="#stroked-chevron-right"/></svg>Звіт по викладачу</a></li>
			<li class="dop-menu"><a href="group.php"><svg class="glyph stroked chevron right"><use xlink:href="#stroked-chevron-right"/></svg>Звіт по групі</a></li>
		</ul>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<div>
							<form action="../zvity_db/teacher_zvit.php" target="_blank" method="post" onsubmit="valid_day(this); return false;">
								<div id="result"></div>
