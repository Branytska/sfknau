...
<head>
<title>СФКНАУ - Довідка - Осн. заходи</title>
...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		<ul class="nav menu">
			...
			<li class="dop-menu, active"><a href="types_of_activities.php"><svg class="glyph stroked chevron right"><use xlink:href="#stroked-chevron-right"/></svg> Види основних заходів</a></li>
		...
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-heading">Види основних заходів</div>
					<div class="panel-body">
						<div>
							<p style="cursor: pointer;"><button id="popup" class="btn btn-default" style="margin-right: 5px;" >Додати запис</button><button id="del_types_of_activities" class="btn btn-default" style="margin-right: 5px;">Видалити запис</button></p>
							<div id="result_add"></div>
						</div>
						<div id="parent_popup">
							<form role="form" onSubmit="return false">
								<div id="input_data" class="form-group">
									<label>Назва основного заходу</label>
									<input id="activitie_name" name="activitie_name" onfocus="this.value=''" class="form-control" placeholder="Введіть назву основного заходу">	
								</div>
								<button id="add_types_of_activities" type="submit" class="btn btn-primary">Додати</button>
							</form>
						</div>
						<div>
						    ...
						    <thead>
						    	<tr>
						        	...
						        	<th data-sortable="true">Назва заходу</th>
						    	</tr>
						    </thead>
						    <?php include '../incdb/inc_types_of_activities.php' ?>
						</table>
					</div>
				</div>
			</div>
